...
export const AppLogoIcon: React.FC<IconProps> = ({ className = 'w-10 h-10' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M21.99,12a2,2,0,0,0-1-1.72L5,3.22a2,2,0,0,0-2.82,2.06l1.93,9.45a1,1,0,0,0,1,.87h7.24l-3.3,3.3a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0L14,16.83V20a1,1,0,0,0,2,0v-5.17l4.47-4.47A2,2,0,0,0,21.99,12ZM15.41,15,5.74,15.29,4.1,7.54l12.44,6.4Z" />
    </svg>
);
...
export const KeyIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4v-1.258l.01-1.42A2 2 0 014.252 18h.508l.01-.004.018-.008.028-.013.04-.02.05-.028.06-.036.07-.045.08-.053.09-.06.1-.068.11-.077.12-.085.13-.092.14-.1.15-.107.16-.114.17-.12.18-.127.19-.133.2-.14.2-.146.21-.15.22-.157.23-.162.24-.167.25-.172.26-.177.27-.182.28-.186.29-.19.3-.194.31-.198.32-.202.33-.205.34-.208.35-.21.36-.213.37-.216.38-.218.39-.22.4-.222.41-.224.42-.226.43-.228.44-.23.45-.232.46-.233.47-.235.48-.236.49-.238.5-.239.51-.24.52-.24.53-.24.54-.24.55-.24.56-.238.57-.237.58-.235.59-.233.6-.23.61-.228.62-.225.63-.222.64-.218.65-.215.66-.21.67-.206.68-.202.69-.197.7-.192.71-.187.72-.182.73-.177.74-.17.75-.164.76-.158.77-.15.78-.143.79-.135.8-.127.81-.12.82-.11.83-.1.84-.093.85-.085.86-.075.87-.065.88-.056.89-.045.9-.035.91-.025.92-.015.93-.005.94 0 .95.004.96.01.97.015.98.02.99.028 1 .035z" />
  </svg>
);